...
public class ControllerGreenChannelAnalysis {
    ...
    void initialize() {
        ...
        //Гистограмма
        int[] invariantOrig = CryptImgAnalysis.getInvariantGreenPixels(myChaoticEncDecColorImg.origImg);
        int[] invariantCrypt = CryptImgAnalysis.getInvariantGreenPixels(myChaoticEncDecColorImg.cryptImg);
        ...
        comparisonTA.appendText("\nUACI: "+ CryptImgAnalysis.getUACIgreenPixels(myChaoticEncDecColorImg.origImg, myChaoticEncDecColorImg.cryptImg));
        System.out.println("Сравнительные хар-ки построены");

        //характеристики оригинала
        origTA.appendText("Энтропия: "+ CryptImgAnalysis.getEntropyGreenPixels(myChaoticEncDecColorImg.origImg));
        origTA.appendText("\nКорреляция");
        origTA.appendText("\n   по горизонтале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.origImg)[0]);
        origTA.appendText("\n   по вертикале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.origImg)[1]);
        origTA.appendText("\n   по диагонале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.origImg)[2]);
        System.out.println("Хар-ки оригинала построены");

        //характеристики криптограммы
        cryptTA.appendText("Энтропия: "+ CryptImgAnalysis.getEntropyGreenPixels(myChaoticEncDecColorImg.cryptImg));
        cryptTA.appendText("\nКорреляция");
        cryptTA.appendText("\n   по горизонтале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.cryptImg)[0]);
        cryptTA.appendText("\n   по вертикале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.cryptImg)[1]);
        cryptTA.appendText("\n   по диагонале: "+ CryptImgAnalysis.getCorrelationGreenPixels(myChaoticEncDecColorImg.cryptImg)[2]);
